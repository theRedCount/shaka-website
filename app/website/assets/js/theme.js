    ...
    $(window).on('load', function () {
        ...
        if ($('.thm__owl-carousel').length) {
            $('.thm__owl-carousel').each(function () {
                ...
                // Funzione per resettare l'autoplay
                function resetAutoplay() {
                    if (carouselOptions.autoplay) {
                        thmCarousel.trigger('stop.owl.autoplay');
                        thmCarousel.trigger('play.owl.autoplay', [carouselOptions.autoplayTimeout]);
                    }
                }
                ...
                // Reset autoplay anche quando si clicca sui dots
                thmCarousel.on('changed.owl.carousel', function(event) {
